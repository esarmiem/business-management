...
nota_tempo +=
  "Le informamos que su reporte de falla fue escalado a nuestro personal en campo. \n";
nota_tempo +=
  "\nEn este momento nos encontramos coordinándolo, tan pronto se cuente con disponibilidad ";
nota_tempo +=
  "en la agenda del personal técnico le estaremos informando. En su correo y en el Portal podrá visualizar nuevas actualizaciones de avance.";

nota1a = nota_tempo; //indisponibilidadpersonalcampo
//--------------------------------------------------
nota_tempo =
  "En  el  momento  no  se  cuenta  con  capacidad  del  personal  en  campo  para  atención,  se  ";
nota_tempo +=
  "estará programando lo más pronto posible apenas haya disponibilidad.";
...
//--------------------------------------------------
nota_tempo =
  "La agenda del personal en campo asignado presenta un retraso para la atención en sitio, le estaremos notificando la nueva hora de atención.\n";
nota_tempo +=
...
nota_tempo =
  "La agenda del personal en campo asignado presenta retraso en el cumplimiento de la cita del día hoy, ";
nota_tempo +=
  "por esta razón será gestionada de manera prioritaria el día de mañana.\n\nEn su correo y en el Portal podrá visualizar nuevas actualizaciones de avance.";
nota3a = nota_tempo; //incumplimientoagenda

//--------------------------------------------------

nota3b =
  "El reporte de falla se encuentra en estado Pendiente, ya que no fue gestionado dentro de la agenda del personal en campo o por modificación en la ruta de trabajo, se dará atención prioritaria el día de mañana según disponibilidad del cliente.";
...
nota4b =
  "Se crea Tarea en  BMC #<> al área encargada de inventarios para que se valide la existencia del material o equipo requerido, se espera respuesta para programar la visita.";
...
nota_tempo =
  "Su reporte de falla se encuentra en gestión de equipos indispensables para la solución de esta.\n";
nota_tempo +=
  "En su correo y en el Portal podrá visualizar nuevas actualizaciones de avance.";
...
notaviatia =
  "En este momento nos encontramos coordinando el desplazamiento del personal en campo al lugar de la falla.\n";
notaviatia +=
  "En su correo y en el Portal podrá visualizar nuevas actualizaciones de avance.";
...
cuerpo1 =
  "El personal en campo asignado, nos indica que debido a , impiden se lleve a cabo la reparación, por lo tanto, reagendaremos su caso para nueva visita el día de mañana.\n\n";
despedida1 =
  "En su correo y en el Portal podrá visualizar nuevas actualizaciones de avance.";
...
nota_tempo +=
  'Teléfono 1: Teléfono de contacto quese encuentra en el incidente de BMC, en la casilla "Contacto", en el campo "Teléfono".\n';
nota_tempo +=
  'Teléfono 2: Segundo teléfono de contacto en caso tal de que se encuentre en el incidente de BMC, en la casilla "Contacto"';
nota_tempo +=
  ', en el campo "Teléfono".\nObservación: El personal en campo indica que no se puede atender el incidente debido';
nota_tempo +=
  " a:(Problemas de orden público/factores climáticos).Se adjunta evidencia fotográfica. El personal en campo informa la ";
...
cuerpo2 =
  "El personal en campo asignado, nos indica que se debe reagendar la visita por motivo de :\n";
...
nota_tempo +=
  " (orden del suscriptor/cliente no autoriza/seguimiento del servicio). Se reagenda nueva visita para el día (fecha que haya indicado el cliente), indicado por el cliente.";

nota6b = nota_tempo;
//------------------------------------------------------------------

cuerpo3 =
  "El personal en campo asignado, nos indica que el lugar de atención se encuentra .\n\nTratamos  de  ubicarlo  en  los  números  de  contacto  registrados  y  no  fue  posible. Por  lo  tanto, reagendaremos su caso para nueva visita el día de mañana.\n\n";
...
nota_tempo = "Fecha y hora: Fecha y hora de la llamada al contacto en sitio.\n";
nota_tempo +=
  'Teléfono 1: Teléfono de contacto que se encuentra en el incidente de BMC, en la casilla "Contacto", en el campo "Teléfono".\n';
nota_tempo +=
  'Teléfono 2: Segundo teléfono de contacto en caso tal de que se encuentre en el incidente de BMC, en la casilla "Contacto"';
nota_tempo +=
...
nota_tempo +=
  "Observación: Si el cliente tiene disponibilidad para atender la visita: Cliente confirma disponibilidad para atender la visita en el horario indicado.\n";
nota_tempo +=
  "Si el cliente no tiene disponibilidad de atender la visita:Cliente no tiene disponibilidad para atender la visita, se reagenda para el día (fecha)en el horario de (hora fija o franja horaria)indicado por el Cliente.\n";
...
nota_tempo +=
  "Contacto en sitio:Nombre de la persona que recibió al personal en el sitio.\n";
nota_tempo +=
  "Observación:El personal en campo indica quese encuentra en sitio.(Breve descripción de lo que está haciendo en el momento).\n";
